...
DRR["2"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["2"]["LayoutOrder"] = 2;
DRR["2"]["Size"] = UDim2.new(0.5404488444328308, 0, 0.1739015281200409, 0);
DRR["2"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["4"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["4"]["ScrollBarImageColor3"] = Color3.fromRGB(128, 0, 128);
DRR["4"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["8"]["ImageColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["9"]["Rotation"] = 90;
DRR["9"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.TopBar.TopBar
DRR["a"] = Instance.new("Frame", DRR["2"]);
DRR["a"]["BorderSizePixel"] = 0;
DRR["a"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["a"]["LayoutOrder"] = 2;
DRR["a"]["Size"] = UDim2.new(0.9983566999435425, 0, 0.05511785298585892, 0);
DRR["a"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["b"]["Rotation"] = -90;
DRR["b"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.TopBar.ProfileMenu
DRR["c"] = Instance.new("Frame", DRR["2"]);
DRR["c"]["BorderSizePixel"] = 0;
DRR["c"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["c"]["BackgroundTransparency"] = 1;
DRR["c"]["Size"] = UDim2.new(0.9983566999435425, 0, 0.4645672142505646, 0);
DRR["c"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["d"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["d"]["Size"] = UDim2.new(0.23481373488903046, 0, 0.682426393032074, 0);
DRR["d"]["Name"] = [[PlayerProfile]];
DRR["d"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["f"]["Rotation"] = 90;
DRR["f"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.TopBar.ProfileMenu.PlayerProfile.ImageLabel
DRR["10"] = Instance.new("ImageLabel", DRR["d"]);
DRR["10"]["BorderSizePixel"] = 0;
DRR["10"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["10"]["Size"] = UDim2.new(0.16644950211048126, 0, 0.8032786846160889, 0);
DRR["10"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["13"]["Rotation"] = 90;
DRR["13"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["14"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["17"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["17"]["Size"] = UDim2.new(0.10328257083892822, 0, 0.682426393032074, 0);
DRR["17"]["Name"] = [[Clock]];
DRR["17"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["19"]["Rotation"] = 90;
DRR["19"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["1b"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["1b"]["Size"] = UDim2.new(0.23481373488903046, 0, 0.682426393032074, 0);
DRR["1b"]["Name"] = [[Title]];
DRR["1b"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["1d"]["Rotation"] = 90;
DRR["1d"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["21"]["Rotation"] = 90;
DRR["21"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.TopBar.TopBarClose.idk
DRR["22"] = Instance.new("Frame", DRR["1f"]);
DRR["22"]["BorderSizePixel"] = 0;
DRR["22"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["22"]["Size"] = UDim2.new(0.2622910141944885, 0, 1, 0);
DRR["22"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["23"]["Rotation"] = 90;
DRR["23"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["28"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["28"]["Size"] = UDim2.new(0.5404488444328308, 0, 0.5745577812194824, 0);
DRR["28"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["2a"]["Rotation"] = 90;
DRR["2a"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(0.231, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["2d"]["ImageColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["2f"]["Rotation"] = 90;
DRR["2f"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["31"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["31"]["ScrollBarImageColor3"] = Color3.fromRGB(128, 0, 128);
DRR["31"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["38"]["Rotation"] = 90;
DRR["38"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.TabButtonReserved.ImageLabel
DRR["39"] = Instance.new("ImageLabel", DRR["33"]);
DRR["39"]["BorderSizePixel"] = 0;
DRR["39"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["39"]["Size"] = UDim2.new(0.19903095066547394, 0, 0.606557309627533, 0);
DRR["39"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["3f"]["Rotation"] = 90;
DRR["3f"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["40"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["40"]["TextSize"] = 14;
DRR["40"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["40"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.19094853103160858, 0);
DRR["40"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["41"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["41"]["TextSize"] = 14;
DRR["41"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["41"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.15457738935947418, 0);
DRR["41"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["42"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["42"]["LayoutOrder"] = 10;
DRR["42"]["Size"] = UDim2.new(0.9684813618659973, 0, 0.29096919298171997, 0);
DRR["42"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["44"]["Rotation"] = 90;
DRR["44"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Dropdown.DropdownBar.UIStroke
DRR["45"] = Instance.new("UIStroke", DRR["42"]);
DRR["45"]["Color"] = Color3.fromRGB(128, 0, 128);

-- DrRay.Folder.Dropdown.DropdownBar.Icon
DRR["46"] = Instance.new("ImageLabel", DRR["42"]);
DRR["46"]["BorderSizePixel"] = 0;
DRR["46"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["46"]["Image"] = [[rbxassetid://14122651741]];
DRR["46"]["Size"] = UDim2.new(0.028106508776545525, 0, 0.59375, 0);
DRR["46"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["46"]["Name"] = [[Icon]];
DRR["46"]["Rotation"] = 180;
...
DRR["48"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["48"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
DRR["48"]["TextStrokeColor3"] = Color3.fromRGB(128, 0, 128);
DRR["48"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["48"]["Size"] = UDim2.new(1, 0, 0.59375, 0);
DRR["48"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["48"]["Text"] = [[none]];
DRR["48"]["Name"] = [[Open]];
...
DRR["49"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["49"]["Selectable"] = false;
DRR["49"]["Size"] = UDim2.new(1, 0, 1, 0);
DRR["49"]["LayoutOrder"] = 10;
DRR["49"]["Name"] = [[Trigger]];
DRR["49"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["49"]["Text"] = [[]];
...
DRR["4a"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["4a"]["LayoutOrder"] = 10;
DRR["4a"]["Size"] = UDim2.new(0.9700000286102295, 0, 0, 0);
DRR["4a"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["4b"]["Rotation"] = 90;
DRR["4b"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Dropdown.Box.UIStroke
DRR["4c"] = Instance.new("UIStroke", DRR["4a"]);
DRR["4c"]["Color"] = Color3.fromRGB(128, 0, 128);
...
DRR["4e"]["MidImage"] = [[]];
DRR["4e"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["4e"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;
DRR["4e"]["BackgroundTransparency"] = 1;
DRR["4e"]["Size"] = UDim2.new(1, 0, 1, 0);
DRR["4e"]["ScrollBarImageColor3"] = Color3.fromRGB(128, 0, 128);
DRR["4e"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["52"]["Rotation"] = 90;
DRR["52"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["53"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["53"]["TextSize"] = 14;
DRR["53"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["53"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.19094853103160858, 0);
DRR["53"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["53"]["Text"] = [[Keybind]];
DRR["53"]["Name"] = [[Title]];
...
DRR["54"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["54"]["TextSize"] = 14;
DRR["54"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["54"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.15457738935947418, 0);
DRR["54"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["55"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["55"]["Size"] = UDim2.new(0.14899714291095734, 0, 0.29096919298171997, 0);
DRR["55"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["57"]["Rotation"] = 90;
DRR["57"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Keybind.Bind.UIStroke
DRR["58"] = Instance.new("UIStroke", DRR["55"]);
DRR["58"]["Color"] = Color3.fromRGB(128, 0, 128);
...
DRR["59"]["TextStrokeColor3"] = Color3.fromRGB(128, 0, 128);
DRR["59"]["TextScaled"] = true;
DRR["59"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["59"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Regular, Enum.FontStyle.Italic);
DRR["59"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["59"]["Selectable"] = false;
DRR["59"]["Size"] = UDim2.new(1, 0, 0.59375, 0);
DRR["59"]["Name"] = [[Button]];
DRR["59"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["59"]["Text"] = [[key]];
...
DRR["5a"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["5a"]["Size"] = UDim2.new(0.9614325165748596, 0, 0.07873434573411942, 0);
DRR["5a"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["5c"]["Rotation"] = 90;
DRR["5c"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["5d"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["5d"]["TextSize"] = 14;
DRR["5d"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["5d"]["Size"] = UDim2.new(0.9668599367141724, 0, 0.5928126573562622, 0);
DRR["5d"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["60"]["Rotation"] = 90;
DRR["60"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["61"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["61"]["TextSize"] = 14;
DRR["61"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["61"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.19094853103160858, 0);
DRR["61"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["61"]["Text"] = [[Speed]];
DRR["61"]["Name"] = [[Title]];
...
DRR["62"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["62"]["Size"] = UDim2.new(0.9684813618659973, 0, 0.29096919298171997, 0);
DRR["62"]["ClipsDescendants"] = true;
DRR["62"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["64"]["Rotation"] = 90;
DRR["64"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Slider.ActualSlider.UIStroke
DRR["65"] = Instance.new("UIStroke", DRR["62"]);
DRR["65"]["Color"] = Color3.fromRGB(128, 0, 128);

-- DrRay.Folder.Slider.ActualSlider.Fill
DRR["66"] = Instance.new("Frame", DRR["62"]);
DRR["66"]["BorderSizePixel"] = 0;
DRR["66"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["66"]["Size"] = UDim2.new(1, 0, 1, 0);
DRR["66"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["68"]["Rotation"] = 90;
DRR["68"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["69"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["69"]["Selectable"] = false;
DRR["69"]["Size"] = UDim2.new(1, 0, 1, 0);
DRR["69"]["LayoutOrder"] = 5;
DRR["69"]["Name"] = [[Trigger]];
DRR["69"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["69"]["Text"] = [[]];
...
DRR["6b"]["Rotation"] = 90;
DRR["6b"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["6c"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["6c"]["TextSize"] = 14;
DRR["6c"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["6c"]["LayoutOrder"] = 3;
DRR["6c"]["Size"] = UDim2.new(0.9582196474075317, 0, 0.5971987247467041, 0);
DRR["6c"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["6c"]["Text"] = [[100]];
DRR["6c"]["Name"] = [[Title]];
...
DRR["6d"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["6d"]["TextSize"] = 14;
DRR["6d"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["6d"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.15457738935947418, 0);
DRR["6d"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["70"]["Rotation"] = 90;
DRR["70"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["71"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["71"]["TextSize"] = 14;
DRR["71"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["71"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.19094853103160858, 0);
DRR["71"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["71"]["Text"] = [[Textbox]];
DRR["71"]["Name"] = [[Title]];
...
DRR["72"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["72"]["TextSize"] = 14;
DRR["72"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["72"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.15457738935947418, 0);
DRR["72"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["73"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["73"]["Size"] = UDim2.new(0.9684813618659973, 0, 0.29096919298171997, 0);
DRR["73"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["75"]["Rotation"] = 90;
DRR["75"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Textbox.TextboxBar.UIStroke
DRR["76"] = Instance.new("UIStroke", DRR["73"]);
DRR["76"]["Color"] = Color3.fromRGB(128, 0, 128);

-- DrRay.Folder.Textbox.TextboxBar.ActualTextbox
DRR["77"] = Instance.new("TextBox", DRR["73"]);
DRR["77"]["PlaceholderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["77"]["BorderSizePixel"] = 0;
DRR["77"]["TextWrapped"] = true;
DRR["77"]["TextStrokeColor3"] = Color3.fromRGB(128, 0, 128);
DRR["77"]["TextScaled"] = true;
DRR["77"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["77"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["77"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["77"]["Text"] = [[]];
...
DRR["7a"]["Rotation"] = 90;
DRR["7a"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(0.765, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["7b"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["7b"]["TextSize"] = 14;
DRR["7b"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["7b"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.323449969291687, 0);
DRR["7b"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["7b"]["Text"] = [[Toggle]];
DRR["7b"]["Name"] = [[Title]];
...
DRR["7c"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["7c"]["TextSize"] = 14;
DRR["7c"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["7c"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.26184046268463135, 0);
DRR["7c"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["7d"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["7d"]["Size"] = UDim2.new(0.03868212550878525, 0, 0.42860323190689087, 0);
DRR["7d"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["7f"]["Rotation"] = 90;
DRR["7f"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Toggle.Label.UIStroke
DRR["80"] = Instance.new("UIStroke", DRR["7d"]);
DRR["80"]["Color"] = Color3.fromRGB(128, 0, 128);
...
DRR["81"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["81"]["Selectable"] = false;
DRR["81"]["Size"] = UDim2.new(1, 0, 1, 0);
DRR["81"]["Name"] = [[Label]];
DRR["81"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["81"]["Text"] = [[]];
...
DRR["83"]["Rotation"] = 90;
DRR["83"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.Button
DRR["84"] = Instance.new("TextButton", DRR["30"]);
DRR["84"]["BorderSizePixel"] = 0;
DRR["84"]["AutoButtonColor"] = false;
DRR["84"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["84"]["Selectable"] = false;
DRR["84"]["Visible"] = false;
DRR["84"]["Size"] = UDim2.new(0.9614325165748596, 0, 0.15495234727859497, 0);
DRR["84"]["Name"] = [[Button]];
DRR["84"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["84"]["Text"] = [[]];
...
DRR["86"]["Rotation"] = 90;
DRR["86"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(0.765, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["87"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["87"]["TextSize"] = 14;
DRR["87"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["87"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.323449969291687, 0);
DRR["87"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["87"]["Text"] = [[Button]];
DRR["87"]["Name"] = [[Title]];
...
DRR["88"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["88"]["TextSize"] = 14;
DRR["88"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["88"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.26184046268463135, 0);
DRR["88"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["89"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["89"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["8b"]["Rotation"] = 90;
DRR["8b"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};

-- DrRay.Folder.DropdownButton.UIStroke
DRR["8c"] = Instance.new("UIStroke", DRR["89"]);
DRR["8c"]["Color"] = Color3.fromRGB(128, 0, 128);
...
DRR["8d"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
DRR["8d"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
DRR["8d"]["TextStrokeColor3"] = Color3.fromRGB(128, 0, 128);
DRR["8d"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["8d"]["Size"] = UDim2.new(1, 0, 0.59375, 0);
DRR["8d"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["8d"]["Text"] = [[none]];
DRR["8d"]["Name"] = [[name]];
...
DRR["90"]["Rotation"] = 90;
DRR["90"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(0.765, Color3.fromRGB(128, 0, 128)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(128, 0, 128))};
...
DRR["91"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["91"]["TextSize"] = 14;
DRR["91"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["91"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.323449969291687, 0);
DRR["91"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
DRR["91"]["Text"] = [[Button]];
DRR["91"]["Name"] = [[Title]];
...
DRR["92"]["BackgroundColor3"] = Color3.fromRGB(128, 0, 128);
...
DRR["92"]["TextSize"] = 14;
DRR["92"]["TextColor3"] = Color3.fromRGB(128, 0, 128);
DRR["92"]["Size"] = UDim2.new(0.9656160473823547, 0, 0.26184046268463135, 0);
DRR["92"]["BorderColor3"] = Color3.fromRGB(128, 0, 128);
...
local GlobalColor1 = Color3.fromRGB(128, 0, 128)
local GlobalColor2 = Color3.fromRGB(128, 0, 128)
local closed = false
	...
	function self:SetTheme(color, color2)
		for i,v in pairs(parent:GetChildren()) do
			if v:IsA("GuiObject") then
				pcall(function()
					if v.BackgroundColor3 == Color3.fromRGB(128, 0, 128) then
						v.BackgroundColor3 = color
						GlobalColor1 = color
					elseif v.BackgroundColor3 == Color3.fromRGB(128, 0, 128) then
