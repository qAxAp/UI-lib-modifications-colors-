...
function library:CreateWindow(name, version, icon)
	...
	Window.Size = UDim2.new(255, 255, 255, 0)
	...
	TitleBar.Size = UDim2.new(255, 255, 255, 30)

	Icon.Name = "Icon"
	Icon.Parent = TitleBar
	Icon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	Icon.BackgroundTransparency = 1.000
	Icon.Position = UDim2.new(255, 255, 255, 6)
	Icon.Size = UDim2.new(255, 255, 255, 18)
	...
	MainTitle.Position = UDim2.new(255, 255, 255, 1)
	MainTitle.Size = UDim2.new(1, -255, 255, 255)
	...
	TitleUnderline.Position = UDim2.new(255, 255, 255, 0)
	TitleUnderline.Size = UDim2.new(255, 255, 255, 1)
	...
	Bar.Position = UDim2.new(255, 255, 255, 0)
	Bar.Size = UDim2.new(255, 255, 255, 0)
	...
	Bar_2.Position = UDim2.new(1, -255, 255, 255)
	Bar_2.Size = UDim2.new(255, 255, 255, 0)

	Close.Name = "Close"
	Close.Parent = TitleBar
	Close.BackgroundTransparency = 1.000
	Close.Position = UDim2.new(0.953333378, 0, 0.0666666627, 0)
	Close.Size = UDim2.new(255, 255, 255, 25)
	Close.ZIndex = 2
	...
	Minimize.Size = UDim2.new(255, 255, 255, 30)
	...
	_4pxShadow2px_2.Size = UDim2.new(255, 255, 255, 30)
	...
	_4pxShadow2px_2.SliceCenter = Rect.new(255, 255, 255, 283)

	Close.MouseButton1Click:Connect(function()
		TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(255, 255, 255, 0)}):Play()
		repeat
			wait()
		until Window.Size == UDim2.new(255, 255, 255, 0)
		wait(0.1)
		TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(255, 255, 255, 0)}):Play()
		repeat
			wait()
	...
	Minimize.MouseButton1Click:Connect(function()
		if not MinimizeGui then
			MinimizeGui = true
			if Window.Size == UDim2.new(255, 255, 255, 400) then
				TS:Create(Window, TweenInfo.new(0.25), {Size = UDim2.new(255, 255, 255, 32)}):Play()
				repeat wait() until Window.Size == UDim2.new(255, 255, 255, 32)
			...
			MinimizeGui = false
			if Window.Size == UDim2.new(255, 255, 255, 32) then
				if Page and Page.Visible == true then
					Page.Visible = false
				end
				if Tabs and Tabs.Visible == true then
				...
				TS:Create(Window, TweenInfo.new(0.25), {Size = UDim2.new(255, 255, 255, 400)}):Play()
			end
		end
	end)
	...
	dragify(Window)
	TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(255, 255, 255, 0)}):Play()
	repeat wait() until Window.Size == UDim2.new(255, 255, 255, 0)
	wait(0.1)
	TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(255, 255, 255, 400)}):Play()
	...
	function tabs:CreateTab(name)
		...
		Tabs.Position = UDim2.new(255, 255, 255, 36)
		Tabs.Size = UDim2.new(255, 255, 255, -41)
		...
		SectionLabel.Position = UDim2.new(255, 255, 255, 0)
		SectionLabel.Size = UDim2.new(1, -255, 255, 255)
		...
		PageButton.Size = UDim2.new(1, -255, 255, 255)
		...
		Indicator.Position = UDim2.new(0, -255, 255, 255)
		Indicator.Size = UDim2.new(255, 255, 255, -8)
		...
		function mytabbuttons:CreateFrame(name)
			...
			Page.Position = UDim2.new(255, 255, 255, 36)
			...
			SearchBar.Size = UDim2.new(255, 255, 255, 30)
			...
			SearchIcon.Position = UDim2.new(255, 255, 255, 6)
			SearchIcon.Size = UDim2.new(255, 255, 255, 18)
			...
			Bar_3.Position = UDim2.new(255, 255, 255, 10)
			Bar_3.Size = UDim2.new(255, 255, 255, -20)

			SearchBox.Name = "SearchBox"
			SearchBox.Parent = SearchBar
			SearchBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			SearchBox.BackgroundTransparency = 1.000
			SearchBox.Position = UDim2.new(255, 255, 255, 1)
			SearchBox.Size = UDim2.new(1, -255, 255, 255)
			...
			SectionContainer.Position = UDim2.new(255, 255, 255.25310734e-07, 0)
			SectionContainer.Size = UDim2.new(255, 255, 255.0033654, -1)
			...
			Header.Size = UDim2.new(255, 255, 255, 8)
			...
			SectionContainer.ChildAdded:Connect(function(me)
				...
				Section.Size = UDim2.new(255, 255, 255,size)
				--[[for i,v in pairs(SectionContainer:GetChildren()) do
			...
			function pagebuttons:CreateButton(name, desc, callback)
				...
				Button.Size = UDim2.new(255, 255, 255, 40)
				...
				Title.Position = UDim2.new(255, 255, 255, 1)
				...
				Description.Position = UDim2.new(255, 255, 255.5, -1)
				...
				Caller.Size = UDim2.new(255, 255, 255, 39)
			...
			function pagebuttons:CreateLabel(name)
				...
				Label.Size = UDim2.new(255, 255, 255, 24)
				...
				_4pxShadow2px.Size = UDim2.new(255, 255, 255, 30)
				...
				_4pxShadow2px.SliceCenter = Rect.new(255, 255, 255, 283)
				...
				LabelContent.Position = UDim2.new(255, 255, 255, 0)
				LabelContent.Size = UDim2.new(1, -255, 255, 255)
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Slider.Size = UDim2.new(255, 255, 255, 40)
				...
				Title_4.Position = UDim2.new(255, 255, 255, 0)
				Title_4.Size = UDim2.new(1, -255, 255, 255)
				...
				Tracker.Position = UDim2.new(255, 255, 255, -10)
				Tracker.Size = UDim2.new(1, -255, 255, 255)

				Indicator_3.Name = "Indicator"
				Indicator_3.Parent = Tracker
				Indicator_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				Indicator_3.BorderSizePixel = 0
				Indicator_3.Size = UDim2.new(255, 255, 255, 0)
				...
				Shadow_1.Size = UDim2.new(255, 255, 255, 30)
				...
				Shadow_1.SliceCenter = Rect.new(255, 255, 255, 283)

				TextButton_2.Parent = Indicator_3
				TextButton_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				TextButton_2.Position = UDim2.new(1, -4, 0.5, -4)
				TextButton_2.Size = UDim2.new(255, 255, 255, 8)
				...
				Shadow_2.Size = UDim2.new(255, 255, 255, 30)
				...
				Shadow_2.SliceCenter = Rect.new(255, 255, 255, 283)
				...
				Fade.Size = UDim2.new(255, 255, 255, 0)
				...
				Value.Position = UDim2.new(1, -255, 255, 255)
				Value.Size = UDim2.new(255, 255, 255, 22)
				...
				ValueText.Size = UDim2.new(255, 255, 255, 0)
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				TextBox.Size = UDim2.new(255, 255, 255, 30)
				...
				Footer_3.Position = UDim2.new(255, 255, 255, -8)
				Footer_3.Size = UDim2.new(255, 255, 255, 8)
				...
				Container_3.Size = UDim2.new(255, 255, 255, -1)
				...
				TextInput.Position = UDim2.new(255, 255, 255, 0)
				TextInput.Size = UDim2.new(1, -255, 255, 255)
				...
				EditIcon.Position = UDim2.new(255, 255, 255, 6)
				EditIcon.Size = UDim2.new(255, 255, 255, 18)
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				Keybind.Size = UDim2.new(255, 255, 255, 30)
				...
				Footer_2.Position = UDim2.new(255, 255, 255, -8)
				Footer_2.Size = UDim2.new(255, 255, 255, 8)
				...
				Container_2.Size = UDim2.new(255, 255, 255, -1)
				...
				Title_3.Position = UDim2.new(0.0169024151, 255, 255, 255)
				Title_3.Size = UDim2.new(255, 255, 255, 29)
				...
				KButton.Size = UDim2.new(255, 255, 255, 22)
			...
			function pagebuttons:CreateToggle(title , desc, callback)
				...
				Toggle.Size = UDim2.new(255, 255, 255, 40)
				...
				ToggleTitle.Position = UDim2.new(255, 255, 255, 1)
				...
				Indicator.Position = UDim2.new(1, -255, 255, 255)
				Indicator.Size = UDim2.new(255, 255, 255, 18)
				...
				Dot.Position = UDim2.new(255, 255, 255, 2)
				...
				TButton.Size = UDim2.new(255, 255, 255, 26)
			...
			function pagebuttons:CreateColorPicker(name, callback)
				...
				ColorPicker.Size = UDim2.new(255, 255, 255, 40)
				...
				Title.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				Title.BackgroundTransparency = 1.000
				Title.Position = UDim2.new(255, 255, 255, 0)
				Title.Size = UDim2.new(1, -255, 255, 255)
				Title.Font = Enum.Font.GothamBlack
				Title.Text = name
				Title.TextColor3 = Color3.fromRGB(255, 255, 255)
				Title.TextSize = 12.000
				...
				ColourGradientFrame.Size = UDim2.new(255, 255, 255, 8)
				...
				Slider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				Slider.Size = UDim2.new(255, 255, 255, 8)
				...
				Slider_2.Size = UDim2.new(0.00300000003, 255, 255, 255)
				...
				Value2.Position = UDim2.new(0.915488005, -255, 255, 255)
				Value2.Size = UDim2.new(255, 255, 255, 17)
				...
				ValueText2.Size = UDim2.new(255, 255, 255, 0)
				ValueText2.Font = Enum.Font.Gotham
				ValueText2.Text = "255, 255, 255"
				...
				function updateColourPreview()
					...
					if ValueText2.Text ~= "255, 255, 255" then
			...
			function CreateNotification(Name, Description, Callback)
				...
				Notification2.Position = UDim2.new(1.25, -255, 255, 255)
				Notification2.Size = UDim2.new(255, 255, 255, 64)
				...
				TitleBar.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				TitleBar.Size = UDim2.new(255, 255, 255, 22)
				...
				Title.Size = UDim2.new(255, 255, 255, 22)
				...
				Corners.Position = UDim2.new(255, 255, 255.799998879, 0)
				Corners.Size = UDim2.new(255, 255, 255, 6)
				...
				TextLabel.Size = UDim2.new(255, 255, 255, 33)
				...
				Negative.Size = UDim2.new(255, 255, 255, 28)
				...
				No.Size = UDim2.new(255, 255, 255, 25)
				No.ZIndex = 2
				...
				Positive.Position = UDim2.new(1.01744187, 255, 255, 255)
				Positive.Size = UDim2.new(255, 255, 255, 28)
				...
				_4pxShadow2px_3.Size = UDim2.new(255, 255, 255, 30)
				...
				_4pxShadow2px_3.SliceCenter = Rect.new(255, 255, 255, 283)
				...
				Yes.Size = UDim2.new(255, 255, 255, 25)
				Yes.ZIndex = 2
